...
// Registry key paths.
	...
	#define KCXP_FAMILY						"GingaCXP"
	#define KCXP_TOKEN						"GINGACXP"
	#define KCXP_CONFIG_PATH				"GingaCXP"
	#define KCXP_CAMFILE_EXT				".gcxp"
	#define KCXP_CAMFILE_FOLDER				"\\GingaCXP"
...
#define R64_INT_FLAG_CXP				0x0080
