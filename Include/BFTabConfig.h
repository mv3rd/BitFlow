...
typedef enum _BF_Families
{
	...
	FF_R64Board				=	FF_R64,
	FF_R64Driver			=	FF_R64_DRIVER,
	FF_AltaAn				=	FF_R64_ALTA,
	FF_AltaCo				=	FF_R64_ALTA_CO,
	FF_KbnCXP				=	FF_R64_CXP,
} BF_Families;

//
typedef enum _BF_ConfigType
{
	CFG_CAM,
	CFG_RCL,
	CFG_RAV,
	...
	CFG_COMP,
	CFG_KCXP,
	CFG_ANY,	// this should always be last
} BF_ConfigTypes;
...
typedef struct _VFORec
{
	...
	BF_ConfigTypes	ConfigType;					// The camera file type for this family and sub-family
