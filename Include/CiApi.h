...
BFDLL BFRC		BFCAPI CiBrdCamGetFileNameWithPath(Bd Board, BFU32 Num, PBFCHAR CamNameWithPath, BFSIZET CamNameWithPathStLen);
...
BFDLL BFRC		BFCAPI CiSignalWaitEx(Bd Board,PCiSIGNAL pSignal, BFU32  TimeOut, PBFU32  pNumInts, BFSignalTimeInfoPtr pTimeInfo);
...
BFDLL BFRC		BFCAPI CiSignalNameGet(Bd Board, BFU32 Type, PBFCHAR SignalName, BFU32 SignalNameSize);
...
BFDLL BFRC		BFCAPI CiConVTrigModeGetEx(Bd Board,PBFU32 TrigMode,PBFU32 TrigAssignments, PBFU32 TrigAPolarity, PBFU32 TrigBPolarity, PBFU32 TrigSelect);
...
BFDLL BFRC		BFCAPI CiConVTrigModeSetEx(Bd Board, BFU32 TrigMode, BFU32 TrigAssignments, BFU32 TrigAPolarity, BFU32 TrigBPolarity, BFU32 TrigSelect);
