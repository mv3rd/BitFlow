...
clBFSerialSettings(void* serBFRef, unsigned int baudRate,
				 unsigned int dataBits,
				 unsigned int parity,
				 unsigned int stopBits);

BFSERIALEXPORT int BFSERIALCC
clBFSerialRead(void* serBFRef, char* buffer, unsigned int* bufferSize );

BFSERIALEXPORT int BFSERIALCC
clBFSerialCancelRead(void* serBFRef);

BFSERIALEXPORT int BFSERIALCC
clBFGetBaudRate(void* serBFRef, unsigned int* baudRate);

BFSERIALEXPORT int BFSERIALCC
clBFSerialInitFromBoardHandle(Bd hBoard, void** serialRefPtr);

BFSERIALEXPORT int BFSERIALCC
clBFGetSerialRef(unsigned int portNum, void** serBFRefPtr);

BFSERIALEXPORT int BFSERIALCC
clBFGetSerialRefFromBoardHandle(Bd hBoard, void** serBFRefPtr);
