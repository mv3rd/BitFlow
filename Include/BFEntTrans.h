...
#define CXPLinkSpeed		(CXPStart + 1)
#define CXPLinkOrder		(CXPStart + 2)
#define CXPCamPwrTimeout	(CXPStart + 3)
#define CXPMisc				(CXPStart + 4)
#define CXPEntConList		(CXPStart + 5)	// list
#define CXPEntStrmToDma		(CXPStart + 6 + CXP_ENTRIES_MAX_CON_REGS)	// list
#define CXPEntCamRegBefore	(CXPStart + 7 + CXP_ENTRIES_MAX_CON_REGS + CXP_ENTRIES_MAX_S2D)  // list
#define CXPEntCamRegAfter	(CXPStart + 8 + CXP_ENTRIES_MAX_CON_REGS + CXP_ENTRIES_MAX_S2D + CXP_ENTRIES_MAX_CAM_REGS)  // list
#define CXPEntComment		(CXPStart + 9 + CXP_ENTRIES_MAX_CON_REGS + CXP_ENTRIES_MAX_S2D + CXP_ENTRIES_MAX_CAM_REGS + CXP_ENTRIES_MAX_CAM_REGS) // last entry can be any size


// Max  CXP entries plus max size of each list entry
#define KCXPCNF_ENTRIES_TOTAL		(CXPStart + 10)
...
// R64 translation table
static BFU32 KCXPTransTable[BFGenEntTableSize] =
{
	R64EntR64,				// BFEntBF,
	BFGenEntNoMatch,		// BFEntName,
	R64EntMake,				// BFEntMake,
