...
#define CXP_CNTRL_COM_MSG_RSP_TIMEOUT		500		// note that should be 200, but life isn't that simple
#define CXP_READ_CHUNK_RSP_TIMEOUT			1000

//
#define CXP_SERDES_CONFIGURE_TIMEOUT		400
...
static CXPBootRegRec CXPBootRegs[NumCXPBootRegs] =
{
	...
	"DeviceFirmwareVersion",	0x00002090,	CXPGroupGenICam,	CXPSupportM,	CXPAccessRO,	32,	CXPIString,
