...
#define CiTrigDiff			BFTrigDiff
#define CiTrigTTL			BFTrigTTL
#define CiTrigOpto			BFTrigOpto
#define CiTrigFVAL			BFTrigFVAL
#define CiTrigVFG0TrigSel	BFTrigVFG0TrigSel
#define CiTrigNTG			BFTrigNTG
#define CiTrigButton		BFTrigButton
#define CiTrigCXPTriggerIn	BFTrigCXPTriggerIn
#define CiTrigSWTrigger		BFTrigSWTrigger
#define CiTrigScanStep		BFTrigScanStep
#define CiTrigNTGVFG0		BFTrigNTGVFG0
#define CiTrigLow			BFTrigLow
#define CiTrigHigh			BFTrigHigh
#define CiTrigUnknown		BFTrigUnknown
...
#define CiEncLow				BFEncLow
#define CiEncHigh				BFEncHigh
#define CiEncVFG0EncASel		BFEncVFG0EncASel
#define CiEncNTG				BFEncNTG
#define CiEncButton				BFEncButton
#define CiEncCXPTriggerIn		BFEncCXPTriggerIn
#define CiEncSWEncoderA			BFEncSWEncoderA
#define CiEncScanStep			BFEncScanStep
#define CiEncNTGVFG0			BFEncNTGVFG0
