...
// Creator:     Bob Sheff
//
// Copyright (C) 1993-2012 by BitFlow, Inc.  All Rights Reserved.
//
// Description:
//
...
#define BF_SDK_V2						0x07
#define BF_SDK_V3						0x00
#define BF_SDK_V4						0x05
...
// Version defines used to build version resources.
	...
	#define BF_LEGAL_COPYRIGHT_STRING		"Copyright © 2008-2013 LinX Corporation\0"
	...
	#define BF_LEGAL_COPYRIGHT_STRING		"Copyright © 1996-2013 BitFlow Inc\0"
	#define BF_COMPANY_STRING				"BitFlow, Inc.\0"
	#define BF_INTERNAL_NAME				"BitFlow.sys\0"

#endif

#define BF_PRODUCT_VERSION_NUMBERS		5, 7, 0, 5
#define BF_PRODUCT_VERSION_STRING		"5.7.0.5\0"

#define BF_FILE_VERSION_NUMBERS			5, 7, 0, 5
#define BF_FILE_VERSION_STRING			"5.7.0.5\0"
