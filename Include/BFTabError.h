...
typedef enum _BFRC_Enum
{
	...
	BF_CXP_POWERUP_ERROR,				// Error powering up camera
	BF_CXP_LINK_ORDER,					// CXP cables are not in the correct order
	BF_CXP_COM_WRITE_ERROR,				// Error writing to CXP register
	BF_CXP_COM_READ_ERROR,				// Error reading CXP register
	BF_ITQ_GET_IN_ADDR_ERR,				// BFIntTimeQueueGetInAddr Error
	BF_ITQ_GET_TIME_ERR,				// BFIntTimeQueueGetTime Error
	BF_ERROR_END
} BFRC_Enum;
